...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(n,t,r){return t&&e(n.prototype,t),r&&e(n,r),n}}(),_ajax=require("./ajax"),_ajax2=_interopRequireDefault(_ajax),_jqueryParam=require("jquery-param"),_jqueryParam2=_interopRequireDefault(_jqueryParam),AjaxAdapter=function(){function e(n){_classCallCheck(this,e),this._base=n&&n.base||""}return _createClass(e,[{key:"create",value:function(e,n,t,r){if(!e._types[n])throw new Error("Unknown type '"+n+"'");var a=(0,_ajax2["default"])({body:JSON.stringify({data:e.convert(n,t)}),crossDomain:!0,headers:{"Content-Type":"application/vnd.api+json"},method:"POST",responseType:"auto",url:this._getUrl(n,null,r)})["do"](function(n){return e.push(n.response)}).map(function(n){return e.find(n.response.data.type,n.response.data.id)}).publish();return a.connect(),a}},{key:"destroy",value:function(e,n,t,r){if(!e._types[n])throw new Error("Unknown type '"+n+"'");var a=(0,_ajax2["default"])({crossDomain:!0,headers:{"Content-Type":"application/vnd.api+json"},method:"DELETE",responseType:"auto",url:this._getUrl(n,t,r)})["do"](function(){return e.remove(n,t)}).publish();return a.connect(),a}},{key:"load",value:function(e,n,t,r){if(t&&"object"==typeof t)return this.load(e,n,null,t);if(!e._types[n])throw new Error("Unknown type '"+n+"'");var a=(0,_ajax2["default"])({crossDomain:!0,headers:{"Content-Type":"application/vnd.api+json"},method:"GET",responseType:"auto",url:this._getUrl(n,t,r)})["do"](function(n){return e.push(n.response)}).map(function(){return t?e.find(n,t):e.findAll(n)}).publish();return a.connect(),a}},{key:"update",value:function(e,n,t,r,a){if(!e._types[n])throw new Error("Unknown type '"+n+"'");var o=e.convert(n,t,r),u=(0,_ajax2["default"])({body:JSON.stringify({data:o}),crossDomain:!0,headers:{"Content-Type":"application/vnd.api+json"},method:"PATCH",responseType:"auto",url:this._getUrl(n,t,a)})["do"](function(){return e.add(o)}).map(function(){return e.find(n,t)}).publish();return u.connect(),u}},{key:"_getUrl",value:function(e,n,t){var r=[],a=n?this._base+"/"+e+"/"+n:this._base+"/"+e;return t&&(r=(0,_jqueryParam2["default"])(t),r.length&&(a=a+"?"+r.join("&"))),a}}]),e}();exports["default"]=AjaxAdapter,module.exports=exports["default"];
