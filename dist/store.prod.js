...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),_ajax=require("./ajax"),_ajax2=_interopRequireDefault(_ajax),_jqueryParam=require("jquery-param"),_jqueryParam2=_interopRequireDefault(_jqueryParam),AjaxAdapter=function(){function e(t){_classCallCheck(this,e),Rx.Observable.isObservable(t)?t.subscribe(setOptions.bind(this)):setOptions(t)}return _createClass(e,[{key:"setOptions",value:function(e){this._base=e&&e.base||"",this._headers=e&&e.headers||""}},{key:"create",value:function(e,t,n,r){if(!e._types[t])throw new Error("Unknown type '"+t+"'");var a=(0,_ajax2["default"])({body:JSON.stringify({data:e.convert(t,n)}),crossDomain:!0,headers:{"Content-Type":"application/vnd.api+json"},method:"POST",responseType:"auto",url:this._getUrl(t,null,r)})["do"](function(t){return e.push(t.response)}).map(function(t){return e.find(t.response.data.type,t.response.data.id)}).publish();return a.connect(),a}},{key:"destroy",value:function(e,t,n,r){if(!e._types[t])throw new Error("Unknown type '"+t+"'");var a=(0,_ajax2["default"])({crossDomain:!0,headers:{"Content-Type":"application/vnd.api+json"},method:"DELETE",responseType:"auto",url:this._getUrl(t,n,r)})["do"](function(){return e.remove(t,n)}).publish();return a.connect(),a}},{key:"load",value:function(e,t,n,r){if(n&&"object"==typeof n)return this.load(e,t,null,n);if(!e._types[t])throw new Error("Unknown type '"+t+"'");var a=(0,_ajax2["default"])({crossDomain:!0,headers:{"Content-Type":"application/vnd.api+json"},method:"GET",responseType:"auto",url:this._getUrl(t,n,r)})["do"](function(t){return e.push(t.response)}).map(function(){return n?e.find(t,n):e.findAll(t)}).publish();return a.connect(),a}},{key:"update",value:function(e,t,n,r,a){if(!e._types[t])throw new Error("Unknown type '"+t+"'");var o=e.convert(t,n,r),s=(0,_ajax2["default"])({body:JSON.stringify({data:o}),crossDomain:!0,headers:{"Content-Type":"application/vnd.api+json"},method:"PATCH",responseType:"auto",url:this._getUrl(t,n,a)})["do"](function(){return e.add(o)}).map(function(){return e.find(t,n)}).publish();return s.connect(),s}},{key:"_getUrl",value:function(e,t,n){var r=t?this._base+"/"+e+"/"+t:this._base+"/"+e;return n&&(r=r+"?"+(0,_jqueryParam2["default"])(n)),r}}]),e}();exports["default"]=AjaxAdapter,module.exports=exports["default"];
